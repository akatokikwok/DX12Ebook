...
void LitColumnsApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	for (int i = 0; i < 5; ++i)
	{
		mMainPassCB.Lights[i].Position = { -5.0f,5.5f,-10.0f + i*5.0f };
		mMainPassCB.Lights[i].Direction = { 0.0f, -1.0f, 0.0f };
		mMainPassCB.Lights[i].Strength = { 0.4f, 0.1f, 0.1f };
		mMainPassCB.Lights[i].SpotPower = 16;

		mMainPassCB.Lights[i + 5].Position = { 5.0f,5.5f,-10.0f + i*5.0f };
		mMainPassCB.Lights[i + 5].Direction = { 0.0f, -1.0f, 0.0f };
		mMainPassCB.Lights[i + 5].Strength = { 0.1f, 0.1f, 0.4f };
		mMainPassCB.Lights[i + 5].SpotPower = 16;
	}
